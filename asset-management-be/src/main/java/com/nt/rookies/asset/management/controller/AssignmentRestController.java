...
public class AssignmentRestController {
  ...
  /**
   * User/ Admin can cancel request of return assignment.<br>
   * Link: <code>/api/v1.0/admin/assignments/{id}/cancel</code><br>
   * Method: DELETE
   *
   * @param id assignment id
   * @return {@link AssignmentDTO} object
   */
  @DeleteMapping("/admin/assignments/{id}/cancel")
  public AssignmentDTO cancelRequestReturning(@PathVariable(name = "id") Integer id){
    return assignmentService.cancelRequestReturning(id);
  }
}
