...
public interface AssignmentService {
  ...
  /**
   * Cancel request of returning for assignment
   *
   * @param id assignment id
   * @return {@link AssignmentDTO} object
   * @exception AssignmentNotFound if assignment not found or asset not found
   * @exception  IllegalAssignmentException if assignment is not in state "Waiting for returning"
   */
  AssignmentDTO cancelRequestReturning(Integer id);
}
