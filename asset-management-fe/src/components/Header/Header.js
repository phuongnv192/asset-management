    ...
    return (
        <nav className="header navbar w-100">
            <div className="grid wide">
                ...
                <FirstLoginModal show={showNewPass} handleClose={handleCloseNewPass} setAccount={setAccount}/>
            </div>
        </nav>
    )
}
